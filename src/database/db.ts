...
export const initializeDatabase = async (): Promise<void> => {
  try {
    ...
    CREATE TABLE IF NOT EXISTS "meal_templates" (
      ...
      "user_id" INTEGER NOT NULL,
      "name" TEXT NOT NULL,
      "items" TEXT NOT NULL, -- JSON array of TemplateItem[]
      "calories" INTEGER NOT NULL CHECK (calories >= 0 AND calories <= 10000),
      "protein" REAL NOT NULL CHECK (protein >= 0 AND protein <= 1000),
      "carbs" REAL NOT NULL CHECK (carbs >= 0 AND carbs <= 1000),
      "fat" REAL NOT NULL CHECK (fat >= 0 AND fat <= 1000),
      "serving_size" REAL NOT NULL DEFAULT 1,
      "serving_size_unit" TEXT NOT NULL DEFAULT 'serving',
